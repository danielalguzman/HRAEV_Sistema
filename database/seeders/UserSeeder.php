...
class UserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::factory()->count(16)->create(
            new Sequence(
                ['name' => 'Daniela Guzmán',        'email' => '1930007@upv.edu.mx', 'password' => Hash::make('password')],
                ['name' => 'Diana González',        'email' => '1930012@upv.edu.mx', 'password' => Hash::make('password')],
                ['name' => 'MSI. Judith Hernández', 'email' => 'jhernandezi@example','password' => Hash::make('password')],
        ...
        Profile::factory()->count(16)->create(
            new Sequence(
                [
                    'first_name'            =>  'Daniela Lizeth',
                    'paternal_last_name'    =>  'Guzmán',
                    'maternal_last_name'    =>  'vázquez',
                    'url_image'             =>  'images/usuario.png',
                    'user_id'               =>  '1',
                    'age'                   =>  '20',
                ],
                ...
                [
                    'first_name'            =>  'Judith Armida',
                    'paternal_last_name'    =>  'Hernández',
                    'maternal_last_name'    =>  'Ilizaliturri',
                    'url_image'             =>  'images/usuario.png',
                    'user_id'               =>  '2',
                    'age'                   =>  '21',
                ],
