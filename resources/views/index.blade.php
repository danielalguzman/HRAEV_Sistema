...
<script src="xglobal_assets/js/demo_pages/dashboard.js"></script>
<!-- /theme JS files -->
        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-5">
                            ...
                            <!-- Sales stats -->
                            <div class="card" Style="height: 72%;">
                                <div class="card-header header-elements-inline">
                                    <h6 class="card-title">Sales statistics</h6>
                                    <div class="header-elements">
                                        <select class="form-control" id="select_date" data-fouc Style="margin-left:50%;">
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card">
                                <div class="card-header header-elements-sm-inline">
                                    ...
                                    <div class="header-elements" Style="margin-left: 60%;">
                        ...
                        <div class="col-xl-4">
                            ...
                            <div class="card">
                                <div class="card-header header-elements-inline">
                                    ...
                                    <div class="header-elements" Style="margin-left: 15%;">
                                        <!--  <span class="font-weight-bold text-danger-600 ml-2">$4,378</span> -->
                                        <div class="list-icons ml-3" Style="width: 1%;"> 
                                            <div class="list-icons-item dropdown" Style="width: 1%;">
                                                <a href="#" Style="width: 1%;" class="list-icons-item dropdown-toggle" data-toggle="dropdown" Style="width: 1%;"><i class="icon-cog3"></i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="#" class="dropdown-item"><i class="icon-sync" Style="width: 3%;"></i> Update data</a>
                                                    <a href="#" class="dropdown-item"><i class="icon-list-unordered" Style="width: 3%;"></i> Detailed log</a>
                                                    <a href="#" class="dropdown-item"><i class="icon-pie5" Style="width: 3%;"></i> Statistics</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a href="#" class="dropdown-item"><i class="icon-cross3" Style="width: 3%;"></i> Clear list</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-header header-elements-inline">
                                    ...
                                    <div class="header-elements" Style="margin-left:12%;">
                                    ...
                                    <div class="row text-center" Style="margin-top:5%;">
                                        ...
                                        <div class="col-4">
                                            <div class="mb-3">
                                                ...
                                                <span class="text-muted font-size-sm">All</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header header-elements-inline">
                                    ...
                                    <div class="header-elements" Style="margin-left: 15%;">
                                        ...
                                        <span class="badge bg-success badge-pill">+86</span> 
                                    </div>
                                </div>
                ...
                <div class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="navbar-footer" Style="border-radius: 2%;">
                        <span class="navbar-text" Style="margin-left: 2%; margin-right: 3%;">
                            &copy; 2022. <a href="#">Sistema para el Marco de Gestión de Seguridad de la Información</a> by <a href="@" target="_blank">Diana González & Daniela Guzmán</a>
                        </span>

                        <ul class="navbar-nav ml-lg-auto" Style="margin-right: 2%; margin-top: 1%; margin-bottom: 1%;">
                            <li class="nav-item" Style="margin-right: 2%"><a href="@" class="navbar-nav-link" target="_blank"><i class="icon-lifebuoy mr-2"></i> Support</a></li>
