...
<div class="page-header d-xl-flex d-block">
    <div class="page-leftheader">
        <h4 class="page-title"><b>Marco de Gestión de Seguridad de la Información (MGSI)</b></h4>
    </div>
                    ...
                    <table class="table  table-vcenter text-wrap table-bordered border-bottom dt" id="project-list">
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">RUBRO</th>
                                <th class="border-bottom-0">ENCARGADO DE LA ULTIMA ACTUALIZACIÓN</th>
                            ...
                            @isset($projects)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <div class="mr-3 mt-0 mt-sm-1 d-block">
                                                <h6 class="mb-1 fs-14"><span class="text-muted mb-0 fs-14">Registro: </span>{{$project->start_date}}</h6>
                                                <h6 class="mb-1 fs-14"><span class="text-muted mb-0 fs-14">Actualizado: </span>{{$project->end_date}}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td width='100px'>
