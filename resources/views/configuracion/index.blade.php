...
<div class="page-header d-xl-flex d-block">
    <div class="page-leftheader">
        <h4 class="page-title"><b>Configuración de la cuenta</b></h4>
    </div>
</div>
<!-- FIN CABECERA -->
...
<!--#-->                                </div>
                        ...
                        <h4 class="mb-5 mt-7 font-weight-bold">Actividades que Realiza</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="type_contract" class="form-label">Extra</label>
