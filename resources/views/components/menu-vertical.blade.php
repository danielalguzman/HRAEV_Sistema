		...
		<ul class="side-menu">
			...
			<li class="slide">
				<a class="side-menu__item {{ Request::is('proyectos') ? 'active' : '' }}" data-toggle="slide" href="{{route('proyectos.index')}}" id="proyectos">
					...
					<span class="side-menu__label">Nivel Operativo</span>
				</a>
			</li>
			...
			<li class="slide">
				<a class="side-menu__item {{ Request::is('profile') ? 'active' : '' }}" data-toggle="slide" href="{{route('profile.index')}}" id="configuraciones">
					...
					<span class="side-menu__label">Configuración de Usuario</span>
				</a>
			</li>
...
<!--
			...
			<li class="slide">
				<a class="side-menu__item {{ Request::is('anuncios') ? 'active' : '' }}" data-toggle="slide" href="{{route('proyectos.create')}}" id="anuncios">
