...
<div class="page-header d-xl-flex d-block">
    <div class="page-leftheader">
        <h4 class="page-title"><b>Control de {{$departamento->name}}</b></h4>
        <ul class="breadcrumb">
            <li class="mb-1 fs-16"><a href="{{ route('departamentos.index') }}">Controles</a></li>
            <li class="text-muted mb-1 fs-16 ml-2 mr-2"> / </li>
            <li class="text-muted mb-1 fs-16">Ver Controles</li>
        </ul>
    </div>
        ...
        <div class="align-items-end flex-wrap my-auto right-content breadcrumb-right">
            <div class="btn-list">
                <a href="empleados/create" class="btn btn-primary mr-3">
                    <i class="feather  feather-plus sidemenu_icon"></i>Agregar Control</a>
            </div>
        </div>
    </div> --}}
</div>
