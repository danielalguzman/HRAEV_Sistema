...
<div class="page-header d-xl-flex d-block">
    <div class="page-leftheader">
        <h4 class="page-title"><b>Ver empleado #{{$user->id}}</b></h4>
        <ul class="breadcrumb">
	    ...
	    <div class="col-8 col-md-12 col-lg-12">
	        <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
						<div class="form-group">
                            <font style="vertical-align: inherit; font-weight:bold">Cargo</font><br>
...
<div class="card-body">
                    ...
                    <div class="row">
						<font style="font-weight:bold">Edad</font>
						<span class="mb-2 fs-14">20</span>
					</div>
					<div class="row">
						<font style="font-weight:bold">Cargo</font>
						<span class="mb-2 fs-14">CEO</span>
					</div>
					<div class="row">
						<font style="font-weight:bold">Departamento</font>
						<span class="mb-2 fs-14">Departamento de dirección general</span>
					</div>
					<div class="row">
						<font style="font-weight:bold">Descripción general</font>
                        <ul>
                            <li class="mb-2 fs-14">Dirigir la empresa</li>
                            <li class="mb-2 fs-14">Suministrar firmas, aprobar proyectos y supervisarlos</li>
                        </ul>
